          ...
          <div className="p-6">
            {applicationsLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">{t('mypage.noApplications')}</h3>
                <p className="text-gray-600 mb-4">
                  {t('mypage.noApplicationsDescription')}
                  <br />
                  {t('mypage.exploreExperiences')}
                </p>
                <button
                  onClick={() => router.push('/')}
                  className="bg-red-600 text-white px-6 py-2 rounded-lg hover:bg-red-700 transition-colors"
                >
                  {t('mypage.browseExperiences')}
                </button>
              </div>
            ) : (
